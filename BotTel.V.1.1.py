...
inbutton1 = InlineKeyboardButton(text="🔹چنل اول ما🔹", url="https://t.me/lovemckIR")
...
markupcity.add(inbutton24, inbutton25, inbutton26, inbutton27, inbutton28, inbutton29, inbutton30, inbutton31,
               inbutton32, inbutton33, inbutton34, inbutton35)
...
irancitymarkup.add(irancity1, irancity2, irancity3, irancity4, irancity5, irancity6, irancity7, irancity8, irancity9,
                   irancity10, irancity11, irancity12, irancity13, irancity14, irancity15, irancity16, irancity17,
                   irancity18, irancity19, irancity20)
...
def agahirig(message):
    ...
    Mokol = message.text
    global msgdaste
    msgdaste = bot.send_message(message.chat.id, reply_markup=markupdaste,
                                text="لطفا یکی از دسته های زیر را انتخاب کنید")
...
def concol1img(message):
    if message.text == "تایید آگهی":
        bot.send_photo(chat_id=6636146690, caption=captioncol1, photo=imgcol1, reply_markup=finalmarkcol1img)
...
📣 @rednews2022 @havashi_russ_2022 @niazmndiha_2024_rus
    ...
    if message.text == "تایید آگهی":
        bot.send_message(chat_id=6636146690, text=text, reply_markup=finalmark)
        bot.send_message(message.chat.id, text="آگهی شما ثبت شد و پس از تایید در کانال قرار داده میشود✅",
                         reply_markup=markup2)
    elif message.text == "لغو آگهی":
        bot.send_message(message.chat.id, text="آگهی شما لغو شد❌", reply_markup=markup2)
...
def conimgcol3(message):
    if message.text == "تایید آگهی":
        bot.send_photo(chat_id=6636146690, caption=captioncol3, photo=photocol3, reply_markup=finalmarkcol3img)
        bot.send_message(message.chat.id, text="آگهی شما ثبت شد و پس از تایید در کانال قرار داده میشود✅",
                         reply_markup=markup2)
    elif message.text == "لغو آگهی":
        bot.send_message(message.chat.id, text="آگهی شما لغو شد❌", reply_markup=markup2)
...
📣 @rednews2022 @havashi_russ_2022 @niazmndiha_2024_rus
    """
    if message.text == "تایید آگهی":
        bot.send_message(chat_id=6636146690, text=text, reply_markup=finalmarkcol3noimg)
        bot.send_message(message.chat.id, text="آگهی شما ثبت شد و پس از تایید در کانال قرار داده میشود✅",
                         reply_markup=markup2)
    elif message.text == "لغو آگهی":
        bot.send_message(message.chat.id, text="آگهی شما لغو شد❌", reply_markup=markup2)
...
def conimgcol4(message):
    if message.text == "تایید آگهی":
        bot.send_photo(chat_id=6636146690, caption=captioncol4, photo=photocol4, reply_markup=finalmarkcol4img2)
        bot.send_message(message.chat.id, text="آگهی شما ثبت شد و پس از تایید در کانال قرار داده میشود✅",
                         reply_markup=markup2)
    elif message.text == "لغو آگهی":
        bot.send_message(message.chat.id, text="آگهی شما لغو شد❌", reply_markup=markup2)
...
📣 @rednews2022 @havashi_russ_2022 @niazmndiha_2024_rus
    """
    if message.text == "تایید آگهی":
        bot.send_message(chat_id=6636146690, text=text, reply_markup=finalmarkcol4noimg)
        bot.send_message(message.chat.id, text="آگهی شما ثبت شد و پس از تایید در کانال قرار داده میشود✅",
                         reply_markup=markup2)
    elif message.text == "لغو آگهی":
        bot.send_message(message.chat.id, text="آگهی شما لغو شد❌", reply_markup=markup2)
...
📣 @rednews2022 @havashi_russ_2022 @niazmndiha_2024_rus
    """
    if message.text == "تایید آگهی":
        bot.send_message(chat_id=6636146690, text=text, reply_markup=finalmarkcol4noimg2)
        bot.send_message(message.chat.id, text="آگهی شما ثبت شد و پس از تایید در کانال قرار داده میشود✅",
                         reply_markup=markup2)
    elif message.text == "لغو آگهی":
        bot.send_message(message.chat.id, text="آگهی شما لغو شد❌", reply_markup=markup2)
...
def other6(message):
    ...
    📣 @rednews2022 @havashi_russ_2022 @niazmndiha_2024_rus        
                   """
    if message.text == "تایید آگهی":
        bot.send_message(chat_id=6636146690, text=text, reply_markup=finalmarkcol5)
        bot.send_message(message.chat.id, text="آگهی شما ثبت شد و پس از تایید در کانال قرار داده میشود✅",
                         reply_markup=markup2)
    elif message.text == "لغو آگهی":
        bot.send_message(message.chat.id, text="آگهی شما لغو شد❌", reply_markup=markup2)
...
def btcfinal(message):
    ...
    ⚠️صحت آگهی های خرید و فروش روبل صرفاً بر عهده آگهی دهنده است و Rusbazar هیچ گونه مسئولیتی در قبال کلاهبرداری های احتمالی قبول نمی کند. لطفا با هوشیاری و احتیاط کامل اقدام به خرید ارز نمایید.
           ...
           📣 @rednews2022 @havashi_russ_2022 @niazmndiha_2024_rus        
               """
    if message.text == "تایید آگهی":
        bot.send_message(chat_id=6636146690, text=text, reply_markup=finalmarkcol6)
        bot.send_message(message.chat.id, text="آگهی شما ثبت شد و پس از تایید در کانال قرار داده میشود✅",
                         reply_markup=markup2)
    elif message.text == "لغو آگهی":
        bot.send_message(message.chat.id, text="آگهی شما لغو شد❌", reply_markup=markup2)
...
def confirm(message):
    ...
    if tct == "لغو ❌":
        ...
        bot.send_message(chat_id=6636146690, text=f"""
    ارسالی از تیکت
نام ارسال کننده :
{UFN}
آیدی ارسال کننده :
